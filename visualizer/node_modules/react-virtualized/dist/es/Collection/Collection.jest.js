...
describe('Collection', function () {
  ...
  function getMarkup() {
    ...
    var _props$cellCount = props.cellCount,
        cellCount = _props$cellCount === undefined ? CELLS.length : _props$cellCount;
  ...
  function simulateScroll(_ref3) {
    ...
    Simulate.scroll(findDOMNode(collection), { target: target });
  }
  ...
  describe('number of rendered children', function () {
    ...
    it('should not render more cells than available if the area is not filled', function () {
      var rendered = findDOMNode(render(getMarkup({ cellCount: 2 })));
    ...
    it('should not render/parent cells that are null or false', function () {
      ...
      var rendered = findDOMNode(render(getMarkup({ cellRenderer: cellRenderer })));
  ...
  describe(':scrollToCell', function () {
    it('should scroll to the top/left', function () {
      var collection = render(getMarkup({ scrollToCell: 0 }));
    ...
    it('should scroll over to the middle', function () {
      var collection = render(getMarkup({ scrollToCell: 7 }));
    ...
    it('should scroll to the bottom/right', function () {
      var collection = render(getMarkup({ scrollToCell: 9 }));
  ...
  describe('property updates', function () {
    it('should update :scrollToCell position when :width changes', function () {
      var collection = findDOMNode(render(getMarkup({ scrollToCell: 3 })));
    ...
    it('should update :scrollToCell position when :height changes', function () {
      var collection = findDOMNode(render(getMarkup({ scrollToCell: 4 })));
  ...
  describe('noContentRenderer', function () {
    ...
    it('should not show the :noContentRenderer when there are children, even if no children are currently visible (sparse)', function () {
      var offscreenSizeAndPosition = { x: SECTION_SIZE * 3, y: SECTION_SIZE * 3, width: 1, height: 1 };

      function cellSizeAndPositionGetter(_ref5) {
  ...
  describe('cell caching', function () {
    ...
    it('should clear cache once :isScrolling is false', function () {
      var _ref11 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee2(done) {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                cellRenderer = function cellRenderer(_ref12) {
                  var isScrolling = _ref12.isScrolling,
                      index = _ref12.index,
                      key = _ref12.key,
                      style = _ref12.style;
  ...
  it('forceUpdate will also forceUpdate the inner CollectionView', function () {
    ...
    cellRenderer.mockImplementation(function (_ref13) {
      var key = _ref13.key;
      return React.createElement('div', { key: key });
    });

    var rendered = render(getMarkup({ cellRenderer: cellRenderer }));
